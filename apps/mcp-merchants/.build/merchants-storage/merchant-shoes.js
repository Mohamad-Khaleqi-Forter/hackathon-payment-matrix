...
exports.getShoesByPriceRange = exports.getShoesByBrand = exports.getShoeById = exports.getAllShoes = exports.shoes = void 0;
exports.shoes = [
    {
        id: "prod_shoes_1",
...
const getShoesByPriceRange = (minPrice, maxPrice) => exports.shoes.filter(shoe => shoe.price >= minPrice && shoe.price <= maxPrice);
